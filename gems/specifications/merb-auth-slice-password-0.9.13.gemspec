Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if current_version >= 3 then
      s.add_runtime_dependency(%q<merb-slices>, [">= 0.9.13"])
      s.add_runtime_dependency(%q<merb-auth-core>, [">= 0.9.13"])
      s.add_runtime_dependency(%q<merb-auth-more>, [">= 0.9.13"])
    else
      s.add_dependency(%q<merb-slices>, [">= 0.9.13"])
      s.add_dependency(%q<merb-auth-core>, [">= 0.9.13"])
      s.add_dependency(%q<merb-auth-more>, [">= 0.9.13"])
    end
  else
    s.add_dependency(%q<merb-slices>, [">= 0.9.13"])
    s.add_dependency(%q<merb-auth-core>, [">= 0.9.13"])
